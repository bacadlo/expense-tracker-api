...
A RESTful API for personal finance management built with FastAPI and PostgreSQL. Track transactions, manage budgets, and analyze spending habits with a comprehensive analytics engine.
